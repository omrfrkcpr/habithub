...
const MainCards = () => {
  return (
    <div className="mt-[100px] mb-[60px] lg:my-0 mx-[100px] lg:mx-0  lg:absolute top-[400px] md:top-[450px] lg:top-[475px] left-[100px] text-center md:text-left md:left-[100px] lg:left-[300px] xl:left-[450px] flex flex-col md:flex-row gap-10">
