...
const Contract: React.FC = () => {
  ...
  return (
    <div className="h-[41.5rem] md:h-[43.4rem] relative max-w-[1800px] mx-auto">
      <Navbar />
      <div className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[90%] max-w-[1200px] flex justify-center items-center md:justify-between flex-col md:flex-row p-5 md:p-10 my-5 rounded-xl shadow-xl bg-habit-light-gray gap-5">
        ...
        <div className="order-0 md:order-1">
          <img
            src={aggrement}
            alt="aggrement"
            className="w-[150px] h-[150px] md:w-[400px] md:h-[400px] relative object-cover"
          />
        </div>
        <button
          onClick={() => setShowSetup(true)}
          className="absolute -bottom-24 md:-bottom-40 left-[50%] -translate-x-[50%] -translate-y-[50%] w-[130px] bg-habit-light-gray hover:bg-gray-200 duration-300 rounded-md shadow-md mb-10 h-[30px] justify-center items-center"
        >
          I Agree
        </button>
      </div>
